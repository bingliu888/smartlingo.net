...
// Flash, Max and Guru are now intentional path/product names in every locale.
const forbidden = /\b(?:Dashboard|Project|Community|Live Chat|Ask Guru|SmartFi|MVP|FAQ|UI|Worker|Member|Message|Messages|News|Events|Profile|Plan|Pricing|Sign in|AIGC|Home|Shop|Status|Build|Version|Launch|Daily|Schedule|Deployments|Roadmap|Task|Milestone|Report|Loading|Error|Open|Closed|Submit|Save|Cancel|Search|Settings|Account|Password|Welcome|Start|Join|Learn more|View|Manage)\b/i;
