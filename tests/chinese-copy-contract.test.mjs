...
test("Chinese shared controls and account notices remain localized", async () => {
  ...
  assert.match(interfaceLocale, /language === "zh-tw" \? "快捷版 · 旗艦版 · Guru"/);
...
test("Chinese My Courses, catalog, pricing, and retired Admin UI are truthful", async () => {
  ...
  for (const label of ["这里只显示您已订阅的课程", "选择课程", "免费初级课程", "Webinar 课程教室", "Group Audio 练习室"]) assert.match(classes, new RegExp(label));
