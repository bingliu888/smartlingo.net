...
import { traditionalChineseText } from "./traditional-chinese";
...
type InterfaceCopy = {
  everyday:string; play:string; courses:string; askAi:string;
  learn:string; practice:string; speak:string; community:string; me:string;
...
const en: InterfaceCopy = { everyday:"Everyday speaking",play:"Learn through play",courses:"Choose course",askAi:"Ask AI",learn:"Learn",practice:"Practice",speak:"Speak",community:"Community",me:"Me",primaryNav:"Primary navigation",openMenu:"Open menu",closeMenu:"Close menu",home:"SmartLingo home",language:"Language",chooseLanguage:"Choose a language",footerNav:"Footer navigation",footerTagline:"Speak from day one · AI Guru · Three course levels · Nine fixed-term packages",project:"Project",about:"About",privacy:"Privacy",terms:"Terms",askGuru:"Ask Guru",account:"Account menu",signIn:"Sign in",openSprint:"Open Today’s Sprint and choose a language and time",startSprint:"Start Today’s Sprint",browseCourses:"Browse Courses",myCourses:"My Courses",chooseLanguageAction:"Choose language",viewPaths:"View learning paths",communityArtAlt:"Learners from different backgrounds practicing language together with an AI voice coach" };
const baseInterfaceCopies: Record<BaseInterfaceLanguage, InterfaceCopy> = {
  en,
  zh:{everyday:"生活口语",play:"边玩边学",courses:"选择课程",askAi:"咨询AI",learn:"学习",practice:"练习",speak:"开口",community:"社区",me:"我的",primaryNav:"主导航",openMenu:"打开菜单",closeMenu:"关闭菜单",home:"SmartLingo 首页",language:"语言",chooseLanguage:"选择语言",footerNav:"页脚导航",footerTagline:"从第一天开口 · 人工智能导师 · 三级课程 · 免费与 Max",project:"项目",about:"关于我们",privacy:"隐私政策",terms:"使用条款",askGuru:"咨询专家",account:"账户菜单",signIn:"登录",openSprint:"打开今日速成，选择语言和时长",startSprint:"开始今日速成",browseCourses:"浏览课程",myCourses:"我的课程",chooseLanguageAction:"选择语言",viewPaths:"查看学习路径",communityArtAlt:"来自不同背景的学习者在人工智能语音导师帮助下共同练习语言"},
  ja:{...en,everyday:"日常会話",play:"遊んで学ぶ",courses:"コースを選ぶ",askAi:"AIに相談",learn:"学ぶ",practice:"練習",speak:"話す",community:"コミュニティ",me:"自分",primaryNav:"メインナビゲーション",openMenu:"メニューを開く",closeMenu:"メニューを閉じる",home:"SmartLingo ホーム",language:"言語",chooseLanguage:"言語を選択",footerNav:"フッターナビゲーション",footerTagline:"初日から話す · AI講師 · 3段階のコース · 9つの期間固定パッケージ",project:"プロジェクト",about:"SmartLingoについて",privacy:"プライバシーポリシー",terms:"利用規約",askGuru:"AI講師に相談",account:"アカウントメニュー",signIn:"ログイン",openSprint:"今日の速習を開き、言語と時間を選択",startSprint:"今日の速習を開始",browseCourses:"コースを見る",myCourses:"マイコース",chooseLanguageAction:"言語を選ぶ",viewPaths:"学習パスを見る",communityArtAlt:"さまざまな背景の学習者がAI音声コーチと一緒に言語を練習している様子"},
  ko:{...en,everyday:"생활 회화",play:"놀면서 배우기",courses:"과정 선택",askAi:"AI에게 질문",learn:"학습",practice:"연습",speak:"말하기",community:"커뮤니티",me:"나",primaryNav:"주요 탐색",openMenu:"메뉴 열기",closeMenu:"메뉴 닫기",home:"SmartLingo 홈",language:"언어",chooseLanguage:"언어 선택",footerNav:"바닥글 탐색",footerTagline:"첫날부터 말하기 · AI 강사 · 3단계 과정 · 9개 기간제 패키지",project:"프로젝트",about:"SmartLingo 소개",privacy:"개인정보 처리방침",terms:"이용약관",askGuru:"AI 강사에게 질문",account:"계정 메뉴",signIn:"로그인",openSprint:"오늘의 속성 학습을 열고 언어와 시간을 선택",startSprint:"오늘의 속성 학습 시작",browseCourses:"과정 둘러보기",myCourses:"내 과정",chooseLanguageAction:"언어 선택",viewPaths:"학습 경로 보기",communityArtAlt:"다양한 배경의 학습자들이 AI 음성 코치와 함께 언어를 연습하는 모습"},
  es:{...en,everyday:"Conversación cotidiana",play:"Aprender jugando",courses:"Elegir curso",askAi:"Preguntar a la IA",learn:"Aprender",practice:"Practicar",speak:"Hablar",community:"Comunidad",me:"Yo",primaryNav:"Navegación principal",openMenu:"Abrir menú",closeMenu:"Cerrar menú",home:"Inicio de SmartLingo",language:"Idioma",chooseLanguage:"Elegir idioma",footerNav:"Navegación del pie",footerTagline:"Habla desde el primer día · Tutor de IA · Tres niveles · Nueve paquetes de plazo fijo",project:"Proyecto",about:"Acerca de",privacy:"Privacidad",terms:"Términos",askGuru:"Preguntar al tutor",account:"Menú de cuenta",signIn:"Acceder"},
  fr:{...en,everyday:"Conversation quotidienne",play:"Apprendre en jouant",courses:"Choisir un cours",askAi:"Demander à l’IA",learn:"Apprendre",practice:"Pratiquer",speak:"Parler",community:"Communauté",me:"Moi",primaryNav:"Navigation principale",openMenu:"Ouvrir le menu",closeMenu:"Fermer le menu",home:"Accueil SmartLingo",language:"Langue",chooseLanguage:"Choisir la langue",footerNav:"Navigation du pied",footerTagline:"Parlez dès le premier jour · Tuteur IA · Trois niveaux · Neuf forfaits à durée fixe",project:"Projet",about:"À propos",privacy:"Confidentialité",terms:"Conditions",askGuru:"Demander au tuteur",account:"Menu du compte",signIn:"Connexion"},
  de:{...en,everyday:"Alltagsgespräche",play:"Spielend lernen",courses:"Kurs wählen",askAi:"KI fragen",learn:"Lernen",practice:"Üben",speak:"Sprechen",community:"Community",me:"Ich",primaryNav:"Hauptnavigation",openMenu:"Menü öffnen",closeMenu:"Menü schließen",home:"SmartLingo Startseite",language:"Sprache",chooseLanguage:"Sprache wählen",footerNav:"Fußzeilennavigation",footerTagline:"Vom ersten Tag an sprechen · KI-Tutor · Drei Kursstufen · Neun Festlaufzeit-Pakete",project:"Projekt",about:"Über uns",privacy:"Datenschutz",terms:"Bedingungen",askGuru:"Tutor fragen",account:"Kontomenü",signIn:"Anmelden"},
  ru:{...en,everyday:"Разговорная практика",play:"Учиться играя",courses:"Выбрать курс",askAi:"Спросить ИИ",learn:"Учиться",practice:"Практика",speak:"Говорить",community:"Сообщество",me:"Я",primaryNav:"Основная навигация",openMenu:"Открыть меню",closeMenu:"Закрыть меню",home:"Главная SmartLingo",language:"Язык",chooseLanguage:"Выбрать язык",footerNav:"Навигация внизу",footerTagline:"Говорите с первого дня · ИИ-наставник · Три уровня · Девять пакетов с фиксированным сроком",project:"Проект",about:"О нас",privacy:"Конфиденциальность",terms:"Условия",askGuru:"Спросить наставника",account:"Меню аккаунта",signIn:"Войти"},
  it:{...en,everyday:"Conversazione quotidiana",play:"Impara giocando",courses:"Scegli corso",askAi:"Chiedi all’IA",learn:"Impara",practice:"Esercitati",speak:"Parla",community:"Comunità",me:"Io",primaryNav:"Navigazione principale",openMenu:"Apri menu",closeMenu:"Chiudi menu",home:"Home SmartLingo",language:"Lingua",chooseLanguage:"Scegli lingua",footerNav:"Navigazione piè di pagina",footerTagline:"Parla dal primo giorno · Tutor IA · Tre livelli · Nove pacchetti a durata fissa",project:"Progetto",about:"Chi siamo",privacy:"Privacy",terms:"Termini",askGuru:"Chiedi al tutor",account:"Menu account",signIn:"Accedi"},
  pt:{...en,everyday:"Conversação diária",play:"Aprender jogando",courses:"Escolher curso",askAi:"Perguntar à IA",learn:"Aprender",practice:"Praticar",speak:"Falar",community:"Comunidade",me:"Eu",primaryNav:"Navegação principal",openMenu:"Abrir menu",closeMenu:"Fechar menu",home:"Início SmartLingo",language:"Idioma",chooseLanguage:"Escolher idioma",footerNav:"Navegação do rodapé",footerTagline:"Fale desde o primeiro dia · Tutor de IA · Três níveis · Nove pacotes de prazo fixo",project:"Projeto",about:"Sobre",privacy:"Privacidade",terms:"Termos",askGuru:"Perguntar ao tutor",account:"Menu da conta",signIn:"Entrar"},
...
export const interfaceCopies: Record<InterfaceLanguage, InterfaceCopy> = {
  ...baseInterfaceCopies,
  "zh-tw": translateTraditionalCopy(baseInterfaceCopies.zh),
};
const helpMenuLabels: Record<InterfaceLanguage,string> = {
  en:"Help", zh:"帮助", "zh-tw":"幫助", ja:"ヘルプ", ko:"도움말", es:"Ayuda", fr:"Aide",
  de:"Hilfe", ru:"Помощь", it:"Aiuto", pt:"Ajuda", ar:"مساعدة", hi:"सहायता",
};
export const interfaceCopyFor = (language: InterfaceLanguage) => ({ ...interfaceCopies[language], help:helpMenuLabels[language], footerTagline: language === "zh" ? "快捷版 · 旗舰版 · Guru" : language === "zh-tw" ? "快捷版 · 旗艦版 · Guru" : "Flash · Max · Guru" });

type AssistantComposerCopy = { question:string; placeholder:string; faq:string; startVoice:string; stopVoice:string; send:string };
const baseAssistantComposerCopy: Record<BaseInterfaceLanguage, AssistantComposerCopy> = {
...
export const assistantComposerCopy: Record<InterfaceLanguage, AssistantComposerCopy> = {
  ...baseAssistantComposerCopy,
  "zh-tw": translateTraditionalCopy(baseAssistantComposerCopy.zh),
};

export function translateTraditionalCopy<T>(value: T): T {
  if (typeof value === "string") return traditionalChineseText(value) as T;
  if (Array.isArray(value)) return value.map(translateTraditionalCopy) as T;
  if (value && typeof value === "object") return Object.fromEntries(Object.entries(value).map(([key, item]) => [key, translateTraditionalCopy(item)])) as T;
  return value;
}

export function interfaceText(language: InterfaceLanguage, english: string, chinese: string) {
  if (language === "zh") return chinese;
  if (language === "zh-tw") return traditionalChineseText(chinese);
...
export function translateHomeCopy<T>(value: T, language: InterfaceLanguage, translations: Record<string, Record<string,string>>): T {
  ...
  if (language === "zh-tw") return translateTraditionalCopy(value);
