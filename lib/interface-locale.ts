...
export const interfaceCopies: Record<InterfaceLanguage, InterfaceCopy> = {
  en,
  zh:{everyday:"生活口语",play:"边玩边学",courses:"选择课程",askAi:"咨询AI",learn:"学习",practice:"练习",speak:"开口",community:"社区",me:"我的",primaryNav:"主导航",openMenu:"打开菜单",closeMenu:"关闭菜单",home:"SmartLingo 首页",language:"语言",chooseLanguage:"选择语言",footerNav:"页脚导航",footerTagline:"从第一天开口 · 人工智能导师 · 三级课程 · 九个固定期限套餐",project:"项目",about:"关于我们",privacy:"隐私政策",terms:"使用条款",askGuru:"咨询专家",account:"账户菜单",signIn:"登录",openSprint:"打开今日速成，选择语言和时长",startSprint:"开始今日速成",browseCourses:"浏览课程",myCourses:"我的课程",chooseLanguageAction:"选择语言",viewPaths:"查看学习路径",communityArtAlt:"来自不同背景的学习者在人工智能语音导师帮助下共同练习语言"},
