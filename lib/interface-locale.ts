...
export const interfaceCopies: Record<InterfaceLanguage, InterfaceCopy> = {
  ...
  fr:{...en,everyday:"Conversation quotidienne",play:"Apprendre en jouant",courses:"Choisir un cours",colleges:"Choisir une académie",askAi:"Demander à l’IA",learn:"Apprendre",practice:"Pratiquer",speak:"Parler",community:"Communauté",me:"Moi",primaryNav:"Navigation principale",openMenu:"Ouvrir le menu",closeMenu:"Fermer le menu",home:"Accueil SmartLingo",language:"Langue",chooseLanguage:"Choisir la langue",footerNav:"Navigation du pied",footerTagline:"Parlez dès le premier jour · Tuteur IA · Trois niveaux · Premier mois gratuit",project:"Projet",about:"À propos",privacy:"Confidentialité",terms:"Conditions",askGuru:"Demander au tuteur",account:"Menu du compte",signIn:"Connexion"},
