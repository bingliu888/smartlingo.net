...
const helpMenuLabels: Record<InterfaceLanguage,string> = {
  en:"Help", zh:"帮助", ja:"ヘルプ", ko:"도움말", es:"Ayuda", fr:"Aide",
  de:"Hilfe", ru:"Помощь", it:"Aiuto", pt:"Ajuda", ar:"مساعدة", hi:"सहायता",
};
export const interfaceCopyFor = (language: InterfaceLanguage) => ({ ...interfaceCopies[language], help:helpMenuLabels[language], footerTagline: language === "zh" ? "快捷版 · 旗舰版 · Guru" : "Flash · Max · Guru" });
