...
const smartLingoRoadmapJson = String.raw`[
  ...
  },
  {
    ...
    "tasks": [
      { "id": "sl-d02-clerk-auth", "status": "blocked", "progress": 90, "title": { "zh": "接入 Clerk 邮箱验证码身份", "en": "Integrate Clerk email-code identity" }, "summary": { "zh": "本地已完成无密码首次注册、会话桥接、缺失要求、验证码与验证码人机保护状态；正式域名仍指向旧站，且 Sites 尚无 Clerk 生产配置，真实邮件与 Safari 会话验收受阻。", "en": "Passwordless first registration, the session bridge, missing requirements, code states, and the CAPTCHA state are complete locally; the production domain still serves the legacy site and Sites has no Clerk production configuration, blocking real email and Safari-session acceptance." } },
