...
const smartLingoRoadmapJson = String.raw`[
  ...
  },
  {
    ...
    "tasks": [
      { "id": "sl-d03-language-catalog", "status": "planned", "progress": 0, "title": { "zh": "发布十二种语言目录", "en": "Publish the twelve-language catalog" }, "summary": { "zh": "为每种语言提供稳定编号、名称、文字方向、语音能力、阶段和当前内容状态，不使用国旗代表语言。", "en": "Give each language a stable ID, name, writing direction, speech capabilities, stages, and current content status without using national flags for languages." } },
      ...
      { "id": "sl-d03-placement-check", "status": "planned", "progress": 0, "title": { "zh": "建立入班自适应分级", "en": "Build class-entry adaptive placement" }, "summary": { "zh": "允许自选初中高级，或完成从中级起步、可暂停和跳过的十五题五技能测评；使用版本化原创题和服务端评分推荐起点，并明确结果不是正式语言证书。", "en": "Allow a self-selected level or a pausable, skippable 15-item five-skill placement starting at intermediate, using versioned original items and server scoring to recommend a non-credential start point." } },
      { "id": "sl-d03-unit-map", "status": "planned", "progress": 0, "title": { "zh": "建立阶段与单元地图", "en": "Build the stage and unit map" }, "summary": { "zh": "将词汇、阅读、写作、听力、对话和真实场景按先决条件组织成可视进度路径。", "en": "Organize vocabulary, reading, writing, listening, dialogue, and real scenarios into a visible prerequisite path." } },
