...
const smartLingoRoadmapJson = String.raw`[
  ...
  },
  {
    ...
    "tasks": [
      { "id": "sl-d04-session-composer", "status": "planned", "progress": 0, "title": { "zh": "建立每日练习编排", "en": "Build the daily session composer" }, "summary": { "zh": "根据目标、阶段、薄弱点和可用时间组合新课、间隔复习、词汇阅读写作听力对话五项练习与结束总结。", "en": "Compose new material, spaced review, five-skill vocabulary/reading/writing/listening/dialogue practice, and a recap from goals, stage, weak areas, and available time." } },
