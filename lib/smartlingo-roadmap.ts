...
const smartLingoRoadmapJson = String.raw`[
  ...
  },
  {
    ...
    "tasks": [
      { "id": "sl-d02-clerk-auth", "status": "blocked", "progress": 90, "title": { "zh": "接入 Clerk 邮箱验证码身份", "en": "Integrate Clerk email-code identity" }, "summary": { "zh": "本地已完成无密码首次注册、会话桥接、缺失要求、验证码与验证码人机保护状态；未配置 Clerk 时公开班级和登录外壳继续可用、受保护路由安全跳转，正式域名与真实邮件、Safari 会话验收仍受阻。", "en": "Passwordless first registration, the session bridge, missing requirements, code states, and the CAPTCHA state are complete locally; public class and sign-in shells remain available and protected routes redirect safely without Clerk, while the production domain and real email and Safari-session acceptance remain blocked." } },
