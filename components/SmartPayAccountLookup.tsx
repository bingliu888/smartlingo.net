...
import { smartPayPlanForIds } from "../lib/crypto-subscription";
...
function recordProduct(row:RecordRow){
  const plan=smartPayPlanForIds(row.mainId,row.secondId);
  return plan?{plan,classId:`platform:${plan}`}:null;
}
