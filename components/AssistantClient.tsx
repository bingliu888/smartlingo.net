...
export function AssistantClient({ lang, targetLanguage, speechLocale, mode, partner: partnerId }: { lang: InterfaceLanguage; targetLanguage?: string; speechLocale?: string; mode?: string; partner?: SmartLingoAiStudyPartnerId }) {
  ...
  const questions = partner
    ...
    : (zh
      ? ["第一次学一门语言，选 Flash 还是 Max？", "怎样找到适合我当前水平的练习？", "每天练十分钟，怎样保持进步？", "Max 的一对一 AI 角色导师能怎样帮我？"]
      : ["Should a new learner choose Flash or Max?", "How can I find practice for my current level?", "How can I make progress with ten minutes a day?", "How can the one-to-one AI role tutor in Max help me?"]);
