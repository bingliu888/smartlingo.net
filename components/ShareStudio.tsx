...
const COPY = {
  zh: {
    ...
    noInviteBody: "请返回用户面板确认账户状态后重试。只有成功支付的平台订阅可能产生介绍人积分，课程付款永不计入。",
    chooseClass: "返回用户面板",
    style: "画面风格",
    anime: "动漫插画（推荐）",
    classic: "职业学习静物（无人）",
  ...
  en: {
    ...
    noInviteBody: "Return to the dashboard to verify your account, then retry. Only a successful platform subscription payment may create introducer points; course payments never qualify.",
