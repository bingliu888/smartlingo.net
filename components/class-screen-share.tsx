...
export function ClassVideoContentShare({client,code,identity,mic,camera,manager,lang,onError,onMedia,apiBase="/api/classes"}:{client:RTKClient;code:string;identity:string;mic:boolean;camera:boolean;manager:boolean;lang:Lang;onError:(message:string)=>void;onMedia:(mic:boolean,camera:boolean)=>Promise<void>;apiBase?:string}){
