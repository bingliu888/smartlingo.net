...
export function CoursePaymentActions({ lang, classId, priceCents, firstMonthFree, trialDays = firstMonthFree ? 30 : 0 }: { lang: "en" | "zh"; classId: string; priceCents: number; firstMonthFree: boolean; trialDays?: number }) {
  const zh = lang === "zh";
