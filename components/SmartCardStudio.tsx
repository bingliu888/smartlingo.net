...
export function SmartCardStudio({ lang, classId }: { lang: "en" | "zh"; classId: string }) {
  ...
  return <section className="sl-smartcard-studio" aria-labelledby="sl-smartcard-title">
    ...
    <p>{zh ? "词卡只取自已发布的审核词库。挑战首次达到 80 分可得 10 点，每日最多 50 点；100 点抵 1 美元，最多抵扣一个符合条件的课程套餐全额。自己挑战自己的词卡不发可抵扣积分。" : "Cards use published, reviewed vocabulary only. A first score of 80 earns 10 points, capped at 50 daily. 100 points offset $1, up to the full price of one eligible course package. Self-challenges do not earn redeemable points."}</p>
