...
export function ClassStudio({
    ...
    return (
      <section className="smartlingo-class-studio">
        ...
        <div className="class-detail-grid">
          {item.classKind === "official_language" && detail.membership?.status === "active" && (
            <article className="class-placement-card" data-layout-fill>
              ...
              <div className="class-learning-actions">
                ...
                {detail.placement?.status === "completed" && <Link className="secondary-button" href={`/${lang}/classes/${encodeURIComponent(item.id)}/learn/session?training=vocabulary`}>Vocab · {lang === "zh" ? "词汇" : "Vocabulary"} →</Link>}
                {detail.placement?.status === "completed" && <Link className="secondary-button" href={`/${lang}/classes/${encodeURIComponent(item.id)}/learn/session?training=dialogue`}>Speaking · {lang === "zh" ? "口语" : "Speaking"} →</Link>}
          ...
          {(detail.isOwner || detail.membership?.status === "active") && (
            <CourseClassroomTile classId={item.id} lang={lang} />
          )}
  ...
  return (
    <section className="smartlingo-class-studio" data-layout-ready="true" data-layout-text-fit="class-studio">
      <header className="class-studio-intro" data-readable-copy="class-studio-intro">
        <p className="section-kicker">{t.eyebrow}</p>
        <h1>{t.title}</h1>
        <p>{t.intro}</p>
      </header>

      <section className="class-catalog" data-layout-fill="joined-classes">
      ...
      <section className="class-catalog class-created-catalog" data-layout-fill="created-classes">
      ...
      <section className="class-catalog class-available-catalog" data-layout-fill="available-classes">
      ...
      <section className="class-economics" aria-labelledby="class-economics-title" data-layout-fill="class-economics">
        <div data-layout-track="class-economics-copy">
        ...
        <dl data-layout-track="class-economics-example">
      ...
      <section className="class-create-panel" data-layout-fill="class-create-panel">
        <div>
...
function ClassStyles() {
  return <style>{`
    ...
    .class-detail-grid .course-classroom-tile{grid-column:1/-1}
    @media(max-width:960px){.class-economics,.class-create-panel,.class-detail-hero{grid-template-columns:1fr}.class-card-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.class-economics dl{width:100%;max-width:none}.class-detail-hero dl{max-width:560px}}
