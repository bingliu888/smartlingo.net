...
export function DailySprint({ lang, classId, durationMinutes, dayNumber: requestedDay, publicPlay = false }: { lang: "zh" | "en"; classId: string; durationMinutes: 5 | 10 | 15 | 20; dayNumber?: number; publicPlay?: boolean }) {
  const zh = lang === "zh";
  ...
  useEffect(() => {
    ...
    fetch(`/api/classes/${encodeURIComponent(classId)}/sprint`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ action: "start", durationMinutes, dayNumber: requestedDay, lang, timeZone, source: publicPlay ? "play" : undefined }) })
  ...
  }, [classId, requestedDay, durationMinutes, lang, publicPlay, zh]);
  ...
  }, [checkpointBucket, classId, plan, publicPlay, responses, roundIndex, runId, stage, wordIndex]);
