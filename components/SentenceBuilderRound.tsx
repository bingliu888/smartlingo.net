...
export function SentenceBuilderRound({ lang, mode, speechLocale, exercises, onComplete }: {
  lang: "zh" | "en";
  ...
  if (complete) return <section className="sentence-round-complete" aria-live="polite"><span>★</span><h4>{zh ? "10 题练习已完成" : "Ten exercises complete"}</h4><p>{zh ? "答案已准备好。提交后会计入今日学习分数。" : "Your answers are ready. Submit to add them to today's learning score."}</p></section>;
