...
export function DashboardCommunityHub({ lang }: { lang: InterfaceLanguage }) {
  ...
  const entries = [
    ...
    { icon: "⌂", title: text("My colleges", "我的学院"), body: text("Join a school, or apply to operate a college with language departments and platform-created learning products.", "加入学校，或申请运营带有语言部门和平台课程产品的学院。"), href: `/${lang}/colleges/mine`, action: text("Manage colleges", "管理学院") },
  ];
