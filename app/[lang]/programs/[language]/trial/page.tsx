...
export default async function AnonymousTrialPage({ params }: { params: Promise<{ lang: string; language: string }> }) {
  ...
  if ((lang !== "en" && lang !== "zh" && lang !== "zh-tw" && lang !== "es" && lang !== "ja" && lang !== "ko" && lang !== "fr" && lang !== "de" && lang !== "ru" && lang !== "it" && lang !== "pt" && lang !== "ar" && lang !== "hi") || !isSmartLingoCommunityLanguage(language)) notFound();
  ...
  const tasks = skills.map(skill => buildDailyPracticeItem(language, skill, date, (lang === "zh" || lang === "zh-tw") ? "zh" : "en", "beginner"));
