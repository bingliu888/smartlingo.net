...
export default async function AdminCertificatesPage({ params, searchParams }: { params: Promise<{ lang: string }>; searchParams: Promise<{ tab?: string; q?: string }> }) {
  ...
  const zh = lang === "zh";
  return <main><SiteHeader lang={lang as any}/><div className="admin-shell" data-layout-page="admin-certificates" data-layout-fill="admin-shell" data-layout-ready="true">
