...
export default async function AdminMembersPage({ params, searchParams }:{params:Promise<{lang:string}>;searchParams:Promise<{tab?:string}>}) {
  const [{lang},{tab}] = await Promise.all([params,searchParams]); if(lang!=="en"&&lang!=="zh")notFound();
