...
const copy = {
  en: {
    ...
    voice: "Try Ask Guru",
    trust: ["10 target languages", "Four-skill practice", "Class communities"],
    ...
    languagesTitle: "Ten languages, one connected learning loop.",
