...
export default async function SmartCardTutorial({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params; if (lang !== "en" && lang !== "zh" && lang !== "zh-tw" && lang !== "es" && lang !== "ja" && lang !== "ko" && lang !== "fr" && lang !== "de" && lang !== "ru" && lang !== "it" && lang !== "pt" && lang !== "ar" && lang !== "hi") notFound(); const zh = lang === "zh" || lang === "zh-tw";
  const steps = zh ? [
    ...
    ["分享给朋友", "复制公开链接。朋友无需登录即可学习；自己挑战自己的卡不会获得奖励积分。"],
    ["安全领取", "每轮从待领取奖励积分开始。完成整轮并登录后才安全入账；积分不等同现金或课程费。"],
    ["兑换数字奖励", "奖励积分可兑换站内数字物品；不可提现、转让或兑换课程使用权。"],
  ] : [
