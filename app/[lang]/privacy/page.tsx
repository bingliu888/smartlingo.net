...
const copy = {
  en: {
    title: "Language, class, community, and voice data should stay understandable.",
    ...
    sections: [
      ["Information we process", "Account and language preferences, learning progress, practice attempts, class membership, direct introducer attribution, platform-subscription reward records, Community and message content, and files you deliberately upload."],
      ...
      ["Class visibility", "A class owner may see roster, attendance, assignments, and privacy-safe progress required to operate that class. Private answers and unrelated account activity are not shared. A class is private unless it completes public-directory review."],
      ...
      ["Introducer rewards", "A one-level introducer relationship may be stored. Reward records are created only by verified successful platform-subscription payment events. Member-created class purchases and owner payouts do not create introducer rewards."],
      ...
      ["Your choices", "Where applicable, you may update your profile, leave a class, manage communications, withdraw optional consent, and request access, correction, export, or deletion through the published contact process."],
