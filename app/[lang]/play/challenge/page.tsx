...
export default async function SmartCardChallengePage({ params, searchParams }: { params: Promise<{ lang: string }>; searchParams: Promise<{ language?: string; level?: string }> }) {
  const value = await params; if (value.lang !== "en" && value.lang !== "zh" && value.lang !== "zh-tw" && value.lang !== "es" && value.lang !== "ja" && value.lang !== "ko" && value.lang !== "fr" && value.lang !== "de" && value.lang !== "ru" && value.lang !== "it" && value.lang !== "pt" && value.lang !== "ar" && value.lang !== "hi") notFound(); const lang = value.lang; const zh = lang === "zh" || lang === "zh-tw"; const query = await searchParams;
