...
const copy = {
  en: {
    ...
    comingBody: "Choose a Basic, Intermediate, or Advanced language course. Every course starts with a free month and includes an A/V webinar classroom.",
    certs: "Certificates",
  ...
  zh: {
    ...
    comingBody: "选择基础、中级或高级语言课程；每门课程首月免费，并配有音视频网络研讨会教室。",
    certs: "结业证书",
