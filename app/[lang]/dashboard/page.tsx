  ...
  return (
    <main className="dashboard-page">
      ...
      <div className="dashboard-wrap">
        ...
        <section className="dashboard-voice-panel"><span className="dashboard-voice-icon" aria-hidden="true"/><div><p className="section-kicker">LIVE CLASSES</p><h2>{lang === "zh" ? "我的课程" : "My Classes"}</h2><p>{lang === "zh" ? "查看创建、管理与加入的实时课程。" : "View live classes you create, manage, and join."}</p></div><a className="dashboard-voice-cta" href={`/${lang}/classrooms?view=mine`}>{lang === "zh" ? "打开我的课程" : "Open My Classes"} →</a></section>
