...
export default async function ClassPage({
  ...
  if (!user) {
    const returnQuery=new URLSearchParams();if(query.invite)returnQuery.set("invite",query.invite);if(targetLanguage)returnQuery.set("language",targetLanguage);
  ...
  return (
    <main className="classes-page">
      ...
      <ClassStudio lang={lang} initialClassId={classId} initialInviteCode={query.invite} initialTargetLanguage={targetLanguage} />
