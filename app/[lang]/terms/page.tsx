...
const copy = {
  en: {
    ...
    sections: [
      ...
      ["Course packages, platform subscriptions, and rewards", "Administrator-created language courses use one-time 3-, 6-, or 12-month packages with no automatic renewal. The learning language and level shown at checkout determine the specific course entitlement. Course-package and member-created course payments are separate from platform subscriptions. Only an eligible verified platform-subscription charge may create the published points for one direct introducer; signup, course-package checkout, course checkout, owner payouts, refunds, disputes, tips, and connected-account charges never create those points."],
  ...
  zh: {
    ...
    sections: [
      ...
      ["课程套餐、平台订阅与奖励", "管理员课程使用一次性支付的 3、6 或 12 个月套餐，不会自动续费；结账时显示的学习语言与等级决定具体课程使用权。课程套餐、会员创建课程付款与平台订阅彼此独立。只有符合资格且验证成功的平台订阅收费可按公布规则为一位直接介绍人产生积分；注册、课程套餐结账、其他课程结账、班主收款、退款、争议、打赏和连接账户收费永不产生这些积分。"],
