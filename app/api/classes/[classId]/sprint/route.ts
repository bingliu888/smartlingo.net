...
type Body = { action?: string; durationMinutes?: number; dayNumber?: number; lang?: string; timeZone?: string; runId?: string; responses?: SprintAnswer[]; source?: string; progress?: { roundIndex?: number; stage?: string; wordIndex?: number; responses?: SprintAnswer[]; remainingSeconds?: number } };
