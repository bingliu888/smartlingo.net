...
async function learningState(
  ...
  const vocabularyFocusPack = (focusResult.results || []).flatMap(row => {
    ...
    return [{
      ...
      difficulty: focusSample.difficulty,
      frequencyDegree: focusSample.frequencyDegree,
      gradeLevel: focusSample.gradeLevel,
  ...
  const vocabularyDeck = vocabularySamples.map((deckSample, index) => {
    ...
    return {
      ...
      difficulty: deckSample.difficulty,
      frequencyDegree: deckSample.frequencyDegree,
      gradeLevel: deckSample.gradeLevel,
  ...
  return {
    ...
    vocabulary: {
      ...
      frequencyDegree: sample.frequencyDegree,
