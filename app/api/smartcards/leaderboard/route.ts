...
export async function GET(request: Request) {
  const url=new URL(request.url); const month=url.searchParams.get("month")||""; const date=url.searchParams.get("date")||""; const language=url.searchParams.get("language")||"";
  ...
  return Response.json({month,language,days,ranking,celebrated});
}
